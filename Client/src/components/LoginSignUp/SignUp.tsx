...
function LoginSignUp(props:SignUp) {
  ...
  const { showSignUp, setShowSignUp } = props;
    return showSignUp ? (
      <div className="bg-[#00000073] fixed top-0 left-0 h-full w-full flex justify-center items-center">
        ...
        <h1 className="text-black mt-5 2xl:text-2xl font-bold 2xl:my-6">Sign Up</h1>

        <form className="h-[50%] 2xl:h-[50%] w-[90%] 2xl:w-[70%] laptop" action="#" method="POST" onSubmit={handleSubmit}>
            <div>
