      ...
      <form onSubmit={onSubmit} action="">
        <div className="flex flex-col justify-center mx-auto mb-4 m-2">
            ...
            <div className="flex justify-center flex-col">
              ...
              {weatherLocation && (
                <>
                  ...
                  <p>Temp: {(weatherLocation.main.temp - 273.15).toFixed(1)}</p>
                  <p>
                    Wind speed: {(weatherLocation.wind.speed * 4.82).toFixed(1)}{" "}
                    km/h
                  </p>
                </>
              )}
          ...
          <div className="flex flex-row">
            ...
            />
            <button
              className="text-blackpy-2 px-4 ml-1 h-10 rounded-lg w-1/2 bg-[#1d335b] hover:bg-[#2d497c]"
              type="submit"
            >
              Search
            </button>
