...
function ModalSMSVerify(props:MoodalSms) {
  ...
  return showSmsVerify ? (
    <div className="bg-[#00000054] fixed top-0 left-0 h-full w-full flex justify-center items-center text-white">
        ...
        <div className="flex flex-col justify-center items-center rounded-3xl bg-[#3c56b4] h-[100%] md:h-[80%] 2xl:h-[65%] w-full md:w-[50%] p-4 md:p-6 mt-40 md:mt-0">
        ...
        <div className="flex flex-row items-end" >
          ...
          <button onClick={() => {setShowSmsVerify(false)}}>
          ...
          <button
            ...
            className="bg-emerald-600 w-[30%] flex gap-1 items-center justify-center py-2.5 text-lg text-white rounded "
          >
            Verify OTP
          </button>
