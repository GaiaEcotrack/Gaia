      ...
      <div className="relative flex flex-col w-full h-full p-4 text-gray-700 bg-white shadow-md rounded-xl bg-clip-border">
        <div className="relative mx-4 mt-4 overflow-hidden text-gray-700 bg-white rounded-none bg-clip-border">
          <div className="flex items-center justify-between gap-8 mb-8">
            <div>
              <h5 className="block font-sans text-xl antialiased font-semibold leading-snug tracking-normal text-gray-700">
                User List
              </h5>
          ...
          <table className="w-full mt-4 text-center table-auto min-w-max">
            <thead>
              <tr>
                ...
                <th className="p-4 border-y border-blue-gray-100 bg-blue-gray-50/50">
                  <p className="block font-sans text-base font-bold leading-none text-gray-700"></p>
                </th>
              </tr>
            </thead>
            <tbody>
              {filteredUsers.map((users: any) => (
                ...
                alt="John Michael" className="relative inline-block h-9 w-9 !rounded-full object-cover object-center" /> */}
                  ...
                  <td className="p-4 border-b border-blue-gray-50">
                    <div className="flex flex-col">
                      <div
                        className={`relative grid items-center py-1 font-sans text-base font-bold uppercase rounded-md select-none whitespace-nowrap ${getStatusColor(
